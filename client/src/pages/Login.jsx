  ...
  return (
    <div className="flex flex-col min-h-screen relative justify-between">
      ...
      <div className="bg-white/30 backdrop-blur-xs flex flex-col md:flex-row relative flex-1">
        {/* Dark overlay */}
        <div className="absolute top-0 left-0 -z-5 w-full h-full bg-black/30" />
        ...
        <div className=" flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-32 relative z-10">
          ...
          {/* Hero Section */}
          <div className="mt-10">
            <h1 className="text-4xl md:text-6xl font-extrabold  leading-tight text-black tracking-wider">
              Share Knowledge, <br />
              <span className="bg-gradient-to-r from-cyan-400 via-teal-500 to-blue-600 text-transparent bg-clip-text">
                Build Connections
              </span>
            </h1>
            <span className=" text-2xl font-bold text-gray-100 drop-shadow-md">
              within Computer Students
            </span>
            <p className="mt-4 text-lg md:text-xl text-gray-200 drop-shadow font-medium">
