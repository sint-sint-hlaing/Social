...
const Login = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50">
      {/* Background Image */}
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-6 mt-8">
            ...
            <div className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm font-medium text-gray-800">Study Groups</p>
            </div>
            <div className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition">
