  ...
  `}
    >
      ...
      <div className="w-full">
        ...
        <Link
          to="/create-post"
          className="flex items-center justify-center gap-2 py-2.5 mt-6 mx-6 rounded-lg bg-gradient-to-r from-cyan-400 via-teal-500 to-blue-600 active:scale-95 transition text-white cursor-pointer"
        >
