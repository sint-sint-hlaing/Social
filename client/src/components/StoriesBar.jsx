      ...
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className="rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-
                ...
                border-2 border-dashed border-cyan-300 bg-gradient-to-b from-cyan-50 to-white"
        >
          <div className="h-full flex flex-col items-center justify-center p-4">
            <div className="size-10 bg-cyan-500 rounded-full flex items-center justify-center mb-3">
