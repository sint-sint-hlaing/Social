...
const StoriesBar =() =>{
    ...
    return(
        <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no scroller
        overflow-x-auto px-4'>
            <div className='flex gap-4 pb-5'>
                {/* Add Story Card */}
                <div className='rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-
                ...
                {/* Story Card */}
                {
                    Stories.map((story,index)=>(
                        ...
                        cursor-pointer hover:shadow-lg transation-all duration-200 bg-gradient-to-b from-indigo-500
                        to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
                            <img src={story.user.profile_picture} alt="" className='absolute size-8 top-3 left-3 z-10
